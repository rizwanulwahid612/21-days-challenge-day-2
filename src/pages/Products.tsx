...
export default function Products() {
  ...
  return (
    <div className="grid grid-cols-12 max-w-7xl mx-auto relative ">
      <div onClick={()=>dispatch(toggleState())} className="col-span-3 z mr-10 space-y-5 border rounded-2xl border-gray-200/80 p-5 self-start sticky top-16 h-[calc(100vh-80px)]">
        <div>
